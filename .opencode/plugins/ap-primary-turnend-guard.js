...
function runGuard(root) {
  ...
  return runProcess(`${root}/bin/ap-turnend-guard.sh`, [], '{"stop_hook_active":false}');
}
...
export const AutopilotPrimaryTurnendGuard = async ({ client, directory, worktree }) => {
  ...
  return {
    event: async ({ event }) => {
      ...
      try {
        const text = await encodeAutopilotOperationalInput(
          root,
          "turn-end-guard",
