...
export const AUTOPILOT_SYNTHETIC_PRESENTATION_TYPE = "autopilot-synthetic-input-presentation";
export const AUTOPILOT_CALM_PRESENTATION_EVENT = "autopilot:calm-presentation";
...
export const AUTOPILOT_SYNTHETIC_KINDS = [
  "session-start",
  "watcher",
  "turn-end-guard",
  "away-supervisor",
...
export type AutopilotSyntheticKind = (typeof AUTOPILOT_SYNTHETIC_KINDS)[number];
type AutopilotSyntheticPresentation = {
  content: string;
  kind: AutopilotSyntheticKind;
};
...
export function registerAutopilotSyntheticPresentation(pi: ExtensionAPI): void {
  pi.registerEntryRenderer<AutopilotSyntheticPresentation>(
    AUTOPILOT_SYNTHETIC_PRESENTATION_TYPE,
    (entry) => {
