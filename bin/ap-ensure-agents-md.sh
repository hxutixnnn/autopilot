...
# This is a worktree utility for flight crew members, not a supervision script, so it does
# not call ap-guard.sh.
# Usage: ap-ensure-agents-md.sh [repo-or-worktree-dir]
set -eu

usage() {
  echo "usage: ap-ensure-agents-md.sh [repo-or-worktree-dir]" >&2
}
