...
This helper is the wire transport for Autopilot's optional presentation-only
...
Wire protocol verified against Herdr 0.7.4, protocol 16:
  ...
  request:  {"id":"ap-workspace-move","method":"workspace.move",
             "params":{"workspace_id":W,"insert_index":N}}\n
  response: {"id":"ap-workspace-move","result":
