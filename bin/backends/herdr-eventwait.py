...
(bin/backends/herdr.sh ap_backend_herdr_wait_transition). It deliberately does
NOT know autopilot's supervision policy: it opens ONE connection to a herdr
...
shape and applies the single-owner policy table (bin/ap-transition-lib.sh); the
